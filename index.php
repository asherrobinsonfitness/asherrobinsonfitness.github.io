...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* For dark mode support on autofill */
        @media (prefers-color-scheme: dark) {
            input:-webkit-autofill,
            input:-webkit-autofill:hover,
            input:-webkit-autofill:focus {
            ...
            /* Improve contrast for icons on dark mode */
            .play-icon {
            ...
            /* Ensure form inputs and validation are visible */
            .form-input {
                color: var(--text);
            }
...
<body>
    ...
    <div class="container mobile-layout">
        <div class="content">
            ...
            <div class="form-wrapper">
                ...
                <p class="form-subtitle">If you're curious how this could help you, send me your contact info so I can show you how this works.</p>
                <form action="calendar.php" method="POST" id="contactForm" class="contact-form" autocomplete="on">
                    ...
                    <div class="fine-print">
                        <p>I respect your privacy. Your email and phone number will only be used to communicate about your coaching inquiry. I will never sell or share your data. Unsubscribe at anytime.
                ...
                <div class="desktop-content">
                    <div class="form-container">
                        <div class="form-wrapper">
                            ...
                            <div class="form-title">Contact Information</div>
                            <p class="form-subtitle">If you're curious how this could help you, send me your contact info so I can show you how this works.</p>
                            <form action="calendar.php" method="POST" id="desktopContactForm" class="contact-form" autocomplete="on">
                                <div class="name-row">
                                    <div class="name-field">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="desktopPhone" class="form-label">Phone number</label>
                                    <div class="validation-mark">✓</div>
                                    <div class="error-message">Please enter a valid phone number</div>
                                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Setup form validation for both mobile and desktop
            ...
            setupFormValidation('desktopContactForm', {
                firstName: document.getElementById('desktopFirstName'),
                lastName: document.getElementById('desktopLastName'),
                email: document.getElementById('desktopEmail'),
                phone: document.getElementById('desktopPhone')
            });
            ...
            function setupFormValidation(formId, inputs) {
