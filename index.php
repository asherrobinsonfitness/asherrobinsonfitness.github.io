...
<head>
    ...
    <style>
        ...
        /* Update image container styles to preserve natural dimensions */
        .image-container {
            position: relative;
            width: 100%;
            max-width: 450px;
        ...
        /* Contact Form Styles - page-specific overrides only */
        .form-wrapper {
            padding-top: var(--space-4);
        }
        ...
        /* Form with floating labels - page-specific */
        .name-field {
            position: relative;
            flex: 1;
        }
    ...
    <div class="container">
        <div class="content">
            ...
            <div class="form-wrapper">
                ...
                <?php endif; ?>
                <form action="beehiiv_integration.php" method="POST" id="contactForm" class="contact-form" autocomplete="on">
                    <div class="name-row">
                    ...
                    <div class="form-group">
                        ...
                        <label for="phone" class="form-label">Phone number (Text notifications)</label>
                        <div class="validation-mark">✓</div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            carousels.forEach(carousel => {
                ...
                // Get carousel width for calculations
                    ...
                    slides.forEach((slide, index) => {
                        ...
                        if (Math.abs(position) <= 1) {
                            ...
                            if (position === 0) {
                                ...
                                const t = Math.min(Math.abs(position), 1);
                                x = rightEdge * t;
                                scale = 1 - (1 - sideScale) * t;
                                opacity = 1 - 0.3 * t;
                            } else {
                                // Moving towards left
                                const t = Math.min(Math.abs(position), 1);
                            ...
                            // Slide is off to the side
                            if (position > 1) {
                                // Far right
                                x = rightEdge;
                                scale = sideScale;
                                opacity = 0.7 * (1 - (position - 1));
                            } else {
                                // Far left
                                x = leftEdge;
                                scale = sideScale;
                ...
                // Touch events with vertical scroll detection
